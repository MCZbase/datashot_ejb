 ...
 * Use database link geog_auth_rec@mczbase_auth and public synonym 
 * mczbase_geog_auth_rec in production Oracle, table below in test MySQL.
 *
 ...
 */
@Entity
@Table(name = "MCZBASE_GEOG_AUTH_REC", catalog = "lepidoptera", schema = "")
@NamedQueries({
	@NamedQuery(name = "MCZbaseGeogAuthRec.findAll", query = "SELECT g FROM MCZbaseGeogAuthRec g")
})
public class MCZbaseGeogAuthRec {
	
    @Id
    @Basic(optional = false)
    @Column(name = "GEOG_AUTH_REC_ID", nullable = false)
	private int geog_auth_rec_id; // GEOG_AUTH_REC_ID
    
    @Column(name = "CONTINENT_OCEAN", length = 70) 
	 ...
	 */
	public int getGeog_auth_rec_id() {
		return geog_auth_rec_id;
	}
	/**
	 * @param geog_auth_rec_id the geog_auth_rec_id to set
	 */
	public void setGeog_auth_rec_id(int geog_auth_rec_id) {
